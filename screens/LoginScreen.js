...
const styles = StyleSheet.create({
  ...
  titulo: { fontSize: 20, fontWeight: 'bold', textAlign: 'center', color: '#292663', marginBottom: 4 },
  ...
  btn: { backgroundColor: '#292663', borderRadius: 10, padding: 14, alignItems: 'center', marginTop: 4 },
  btnTxt: { color: 'white', fontWeight: 'bold', fontSize: 15 },
  switchTxt: { color: '#292663', textAlign: 'center', marginTop: 16, fontSize: 13 },
});